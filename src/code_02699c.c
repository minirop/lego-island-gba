...
__attribute__((naked)) void fun_08027160()
{
    asm("\n\
     ...
     str        r0,[r4,#0x8]\n\
     ldr        r0,[r4,#0x8]\n\
     ldr        r0,PTR_DAT_0802729c\n\
     strb       r5,[r0,#0x0]\n\
     ldr        r0,PTR_DAT_080272a0\n\
     mov        r4,#0x0\n\
     str        r4,[r0,#0x0]\n\
     ldr        r0,PTR_DAT_080272a4\n\
     strh       r4,[r0,#0x0]\n\
     ldr        r0,PTR_DAT_080272a8\n\
     str        r4,[r0,#0x0]\n\
     ldr        r0,PTR_DAT_080272ac\n\
     strh       r4,[r0,#0x0]\n\
     ldr        r0,PTR_DAT_080272b0\n\
     strb       r5,[r0,#0x0]\n\
     ldr        r1,PTR_DAT_080272b4\n\
     mov        r0,#0x4d\n\
     strb       r0,[r1,#0x0]\n\
     ldr        r0,PTR_DAT_080272b8\n\
     strb       r5,[r0,#0x0]\n\
     ldr        r5,DAT_080272bc\n\
     add        r0,r5,#0x0\n\
     bl         fun_08003998\n\
...
__attribute__((naked)) void fun_080272d4()
{
    asm("\n\
     push       {r4,lr}\n\
     bl         fun_08027900\n\
     ldr        r1,PTR_DAT_080273e0\n\
     ldr        r0,[r1,#0x0]\n\
     add        r0,#0x11\n\
     str        r0,[r1,#0x0]\n\
     ldr        r1,PTR_DAT_080273e4\n\
     ldrb       r0,[r1,#0x0]\n\
     cmp        r0,#0x0\n\
     beq        LAB_080272fc\n\
     sub        r0,#0x1\n\
     ...
     cmp        r0,#0x0\n\
     bne        LAB_080272fc\n\
     ldr        r0,PTR_DAT_080273e8\n\
     ldr        r1,[r0,#0x0]\n\
     mov        r0,#0x1\n\
     strh       r0,[r1,#0x0]\n\
LAB_080272fc:\n\
     ldr        r1,PTR_DAT_080273ec\n\
     ldrb       r0,[r1,#0x0]\n\
     cmp        r0,#0x0\n\
     beq        LAB_08027316\n\
     sub        r0,#0x1\n\
     ...
     cmp        r1,#0x0\n\
     bne        LAB_08027316\n\
     ldr        r0,PTR_DAT_080273f0\n\
     ldr        r0,[r0,#0x0]\n\
     strh       r1,[r0,#0x0]\n\
LAB_08027316:\n\
     ldr        r1,PTR_DAT_080273f4\n\
     ldrb       r0,[r1,#0x0]\n\
     add        r0,#0x1\n\
     strb       r0,[r1,#0x0]\n\
     lsl        r0,r0,#0x18\n\
...
LAB_08027332:\n\
     ...
     bl         fun_080016b0\n\
LAB_0802734a:\n\
     ldr        r0,PTR_DAT_080273fc\n\
     ldrh       r0,[r0,#0x0]\n\
     cmp        r0,#0x0\n\
     beq        LAB_0802736c\n\
     ldr        r1,PTR_DAT_08027400\n\
     mov        r0,#0x1\n\
     strh       r0,[r1,#0x0]\n\
     ldr        r1,PTR_DAT_08027404\n\
     ldr        r0,PTR_DAT_08027408\n\
     ldrh       r0,[r0,#0x0]\n\
     str        r0,[r1,#0x0]\n\
     ldr        r1,PTR_DAT_0802740c\n\
     mov        r0,#0x0\n\
     str        r0,[r1,#0x0]\n\
     mov        r0,#0x10\n\
     bl         fun_08001070\n\
